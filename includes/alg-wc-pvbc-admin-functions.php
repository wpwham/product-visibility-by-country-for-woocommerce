<?php
/**
 * Product Visibility by Country for WooCommerce - Admin Functions
 *
 * @version 1.3.3
 * @since   1.0.0
...
if ( ! function_exists( 'alg_wc_pvbc_get_countries' ) ) {
	/**
	 * alg_wc_pvbc_get_countries.
	 *
	 * @version 1.3.3
	 * @since   1.0.0
	 */
	function alg_wc_pvbc_get_countries() {
		return apply_filters( 'alg_wc_pvbc_get_countries', array(
